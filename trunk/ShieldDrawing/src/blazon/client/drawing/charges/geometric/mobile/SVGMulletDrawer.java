...
public class SVGMulletDrawer extends SVGMobileChargeDrawer {
	...
	public SVGMulletDrawer(GeometricCharge charge, OMSVGDefsElement defs, int shieldWidth, int shieldHeight, int occurrences) {
	...
	public OMSVGGElement drawCharge(CubicBezierCurve curve) {
		...
		final float chargeHeight = getYDiff()/(float)(1+occurrences);
