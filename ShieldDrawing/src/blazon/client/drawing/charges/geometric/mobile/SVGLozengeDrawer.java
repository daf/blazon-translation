...
public class SVGLozengeDrawer extends SVGMobileChargeDrawer {

	public SVGLozengeDrawer(GeometricCharge charge, OMSVGDefsElement defs, List<ShieldDiagnostic> diags, int shieldWidth, int shieldHeight, int occurrences) {
